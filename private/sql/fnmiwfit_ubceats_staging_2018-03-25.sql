...
#
# Host: sequel.gottardo.me (MySQL 5.5.5-10.2.13-MariaDB)
# Database: fnmiwfit_ubceats_staging
# Generation Time: 2018-03-25 17:14:26 +0000
# ************************************************************
...
VALUES
	('Bento Sushi','http://www.food.ubc.ca/place/bento-sushi',''),
	('Gage Market','http://www.food.ubc.ca/place/gage-mini-mart/',''),
	('Gather At Vanier','http://www.food.ubc.ca/place/gather/',''),
	('Ike\'s Caf&eacute;','http://www.food.ubc.ca/place/ikes',''),
	('IRC Snackbar','http://www.food.ubc.ca/place/irc-snackbar',''),
	('Law Caf&eacute;','http://www.food.ubc.ca/place/law-cafe',''),
	('Magma Caf&eacute;','http://www.food.ubc.ca/place/magma-cafe',''),
	('Mercante','http://www.food.ubc.ca/place/mercante/',''),
	('Neville\'s Caf&eacute;','http://www.food.ubc.ca/place/nevilles',''),
	...
	('Stir It Up Caf&eacute;','http://www.food.ubc.ca/place/stir-it-up-cafe/',''),
	...
	('test brand','https://www.iloveyourachel.ca',''),
	('The Hungry Nomad','http://www.food.ubc.ca/place/hungry-nomad/',''),
	('The Loop Caf&eacute;','http://www.food.ubc.ca/place/loop-cafe/',''),
	('The Point Grill','http://www.food.ubc.ca/place/the-point-grill/',''),
	...
	('Triple O\'s','http://www.food.ubc.ca/place/triple-o','');
...
VALUES
	...
	('Food truck','A meal with the wheels.'),
...
VALUES
	...
	('Daily Hot Entrees','The Loop Caf&eacute;',9),
	...
	('Fresh salad bar','The Loop Caf&eacute;',8),
	...
	('Miso Mushroom Soup','Pacific Puke',2),
	...
	('Pastry and baked goods','The Loop Caf&eacute;',3),
	...
	('The Cali','Pacific Puke',11),
	('The Grill','Totem Dining Room',9),
	('The Keefer','Pacific Puke',12),
	('The Main','Pacific Puke',14),
	('The Veggie','Pacific Puke',11),
...
CREATE TABLE `itemHas` (
  `itemName` char(25) NOT NULL DEFAULT '',
  `categoryName` char(25) NOT NULL DEFAULT '',
  `brandName` char(25) NOT NULL,
  PRIMARY KEY (`itemName`,`categoryName`,`brandName`),
  KEY `categoryName` (`categoryName`),
  KEY `itemHas_ibfk_3` (`itemName`,`brandName`),
  CONSTRAINT `itemHas_ibfk_2` FOREIGN KEY (`categoryName`) REFERENCES `categories` (`name`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `itemHas_ibfk_3` FOREIGN KEY (`itemName`, `brandName`) REFERENCES `food_items` (`name`, `brandName`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
VALUES
	...
	('Al Pesto pizza','Vegan','Mercante'),
	('Bacon Cheddar Burger','Fast food','Triple O\'s'),
...
VALUES
	...
	('Law Caf&eacute;','Allard Hall','1822 East Mall'),
	('Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	('Mercante','Ponderosa Commons','6488 University Boulevard'),
	('Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	('Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	('Pacific Puke','ICICS','2366 Main Mall'),
	('Perugia Italian Cafe','Life Sciences Centre','2350 Health Sciences Mall'),
	('Sage Restaurant','Univeristy Centre','6331 Crescent Rd'),
	('Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	...
	('Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	('Subway','Life Building','6138 Student Union Blvd'),
	('Subway','Village','2178 Western Pkwy'),
	('test brand','test location','5959 West Mall'),
...
VALUES
	...
	(1,730,1700,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(1,730,1430,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(1,730,2359,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(1,730,1645,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(1,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(1,-1,-1,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(1,730,2000,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(1,730,1900,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(2,730,1700,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(2,730,1430,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(2,730,2359,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(2,730,1645,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(2,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(2,1000,1900,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(2,730,2000,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(2,730,1900,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(3,730,1700,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(3,730,1430,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(3,730,2359,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(3,730,1645,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(3,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(3,1000,1900,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(3,730,2000,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(3,730,1900,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(4,730,1700,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(4,730,1430,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(4,730,2359,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(4,730,1645,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(4,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(4,1000,1900,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(4,730,2000,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(4,730,1900,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(5,730,1700,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(5,730,1430,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(5,730,2359,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(5,730,1415,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(5,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(5,1000,1900,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(5,730,1600,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(5,730,1900,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(6,-1,-1,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(6,-1,-1,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(6,1000,2200,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(6,-1,-1,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(6,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(6,-1,-1,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(6,900,1600,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(6,-1,-1,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
	...
	(7,-1,-1,'Law Caf&eacute;','Allard Hall','1822 East Mall'),
	(7,-1,-1,'Magma Caf&eacute;','Earth Sciences Building','6339 Stores Road'),
	(7,1000,2200,'Mercante','Ponderosa Commons','6488 University Boulevard'),
	(7,-1,-1,'Neville\'s Caf&eacute;','Neville Scarfe Building','2125 Main Mall'),
	(7,700,2200,'Open Kitchen','Orchard Commons','6363 Agronomy Rd'),
	(7,-1,-1,'Pacific Puke','ICICS','2366 Main Mall'),
	...
	(7,-1,-1,'Sauder Exchange Caf&eacut','Henry Angus Building','2053 Main Mall'),
	(7,-1,-1,'Stir It Up Caf&eacute;','Buchanan Block A','1866 Main Mall'),
...
VALUES
	...
	('ian','!worth_admin_right','iandelriow@gmail.com',0),
...
VALUES
	(1,'yummy food','','Buffalo Chickpea Veggie Burger','The Point Grill','2018-03-25 12:54:50'),
	(1,'no. shitty coffee.','','Coffee','Starbucks','2018-03-24 15:09:23'),
	...
	(1,'This is disgusting','andrea','The Main','Pacific Puke','2018-03-24 14:03:39'),
